// src/modules/Costumer/Costumer.service.ts

import { CreateCustomer, DeleteCustomer, UpdateCustomer } from './costumer.validators';
import { CostumerResponse } from './costumer.types';
...
export const deleteCustomer = async (data: DeleteCustomer): Promise<CostumerResponse> => {
